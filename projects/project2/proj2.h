...
This file contains the header files and all the includes. It also has
the constants and prototype functions that are included in the
proj2.cpp file.
*/
...
const int MAX_POKEMON = 150;
const int MIN_POKEMON = 0;
